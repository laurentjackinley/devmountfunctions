...
// CODE HERE
const multiply = (num1, num2, willCallBack) => willCallBack(num1 * num2)
...
// CODE HERE 
const first = (arrNam, NameCallBack) => NameCallBack(arrNam[0])
...
// CODE HERE
const last = (arr, callBack1) => callBack1(arr[6])
...
// CODE HERE 
const contains = (arr, name, callBack2) => {
...
// CODE HERE
uniq(names, uniqArr =>console.log(`The new name array with all duplicate items removed is ${uniqArr}`) )
...
// CODE HERE 
const each = (arrNames,callback) => arrNames.forEach((element, index) => callback(element, index))
