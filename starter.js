...
const calculator = (num1, num2, callback) =>{
    //check to see if num1 and num2 can be coerced into a number
    //if they are able to be numbers and call the call back to do our math
    // if they cant be number,we warn them that they need to be numbers
    if (+num1 && +num2) {
        num1 = +num1
        num2 = +num2
        return callback(num1, num2)
    } else{
        console.log("Hey, Send me some nums")
    }
}
let result =  calculator(5,6,add)
console.log(result)
result = calculator(10,8,substract)
console.log(result)
result = calculator(5,5,multiply)
console.log(result)
result = calculator(8,2,divide)
console.log(result)
///////////////////////
////// PET STORE //////
///////////////////////
